...
const Headshot = () => {
  return (
    ...
    <div className="md:pt-20">
        <div className="animate-[spin_5s_linear_infinite] bg-gradient-to-r from-[#495464] from-50% to-[rgb(244,244,242)] p-0  md:p-28 lg:p-48 rounded-[250px] md:rounded-[50%] relative"></div>
